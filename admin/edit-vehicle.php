			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">កែប្រែ រថយន្ត</h2>
...
<label class="col-sm-2 control-label">ប្រភេទរថយន្ត<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">ជ្រើសរើស គោលដៅ ខេត្ត <span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">អំពី រថយន្ត<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<label class="col-sm-2 control-label">ជ្រើសរើស ទីតាង<span style="color:red">*</span></label>
<div class="col-sm-4">
