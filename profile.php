  ...
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      ...
      <div class="dealer_info">
        ...
        <p>អុីម៉ែល : <?php echo htmlentities($result->EmailId);?><br>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">ទិន្ន័យរបស់ អតិថជន</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>ផោគជ័យ </strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">ថ្ងៃចុះឈ្មោះ -</label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label">មានការកែប្រែ  -</label>
            ...
            <div class="form-group">
              <label class="control-label">អុីម៉េល</label>
            ...
            <div class="form-group">
              <label class="control-label">លេខទូស័ព្ធ</label>
            ...
            <div class="form-group">
              <label class="control-label">ថ្ងៃខែឆ្នាំ/កំណើត&nbsp;(ថ្ងៃ/ខែ/ឆ្នាំ)</label>
            ...
            <div class="form-group">
              <label class="control-label">ទីតាំងរស់នៅ បច្ចប្បន្ន</label>
              <textarea class="form-control white_bg" name="address" rows="4" ><?php echo htmlentities($result->Address);?></textarea>
            </div>
            <?php }} ?>
           
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">រក្សាទុក<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
